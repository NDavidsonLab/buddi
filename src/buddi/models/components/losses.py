...
def kl_loss_generator(
    beta: float = 1.0, agg_fn: LossAggregationFn = K.sum, **kwargs: Any
) -> Callable:
...
def reconstr_loss_generator(
    ...
    **kwargs: Any,
    ...
    def reconstr_loss(y_true: tf.Tensor, y_pred: tf.Tensor) -> tf.Tensor:
        """
...
def classifier_loss_generator(
    ...
    **kwargs: Any,
    ...
    def classifier_loss(y_true: tf.Tensor, y_pred: tf.Tensor) -> tf.Tensor:
...
def unsupervised_dummy_loss_fn(y_true: tf.Tensor, y_pred: tf.Tensor) -> tf.Tensor:
    """
