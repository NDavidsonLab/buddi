...
class BuDDIAbstract(ABC):
        ...
        **kwargs,  # to collect the n_{branch_name} arguments
        ...
        for branch_name in self._encoder_branch_names:
            ...
            self._losses[f"{branch_name}_pred"] = (
                CategoricalCrossentropy(reduction="sum"),
                1.0,
            )
    ...
    def set_encoder_loss(
        self, branch_name: Union[str, List[str]], fn: Callable, weight: float = 1.0
    ):
        """
    ...
    def set_all_encoder_losses(self, fn: Callable, weight: float = 1.0):
        ...
        self.set_encoder_loss(
            self.encoder_branch_names + [self._slack_branch_name], fn, weight
        )
    ...
    def set_reparam_deterministic(
        self, deterministic: bool, seed: Optional[int] = None
    ):
        """
    ...
    def compile(self, optimizer: Optimizer = None):
        ...
        sup_X_hat = self._sup_decoder([sup_Y] + sup_zs)
        ...
        unsup_X_hat = self._unsup_decoder([unsup_Y_hat] + unsup_zs)
