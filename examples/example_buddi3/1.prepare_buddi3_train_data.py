...
# %% [markdown]
# # This notebook demonstrates final integration and normalization steps on augmetned single cell reference and bulk data before training buddi3 model from buddi_v2
...
# %%
(_X, _y, _label, _samp_type, _meta) = train_data.get()
...
train_data.reset_query().plot(
    color_by=[SAMPLE_ID_COL, TECH_COL, train_data.split_column, train_data.ct_column],
    panel_width=8,
    show_plot=True,
)
...
# %%
_ = joblib.dump(train_data.reset_query(), DATA_PATH / "buddi3_data.pkl")
